...
final class UserEntity extends AbstractEntity
{
    ...
    // IMPORTANT : stocké depuis la BDD (bcrypt/argon)
    private string $password_hash = '';

    // (optionnel legacy) si tu as encore une colonne `password` en clair
    ...
    public function getPassword(): ?string { return $this->password; } // legacy
    ...
    // Les deux setters qui manquaient pour l’auth
    public function setPasswordHash($v): void { $this->password_hash = (string)$v; }
    public function setPassword($v): void { $this->password = $v !== null ? (string)$v : null; } // legacy
